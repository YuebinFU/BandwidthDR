...
#region Recv from Server
        ...
        public event Action PingCallback = delegate { };
        ...
        public static float HeartbeatTimeout = float.PositiveInfinity;//5f;
        public static float HeartbeatInterval = float.PositiveInfinity;
